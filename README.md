...
```
Aliases      : asveria, rich
Interests    : Cybersecurity, Identity Protection, Business, Management, Frontend Work, Design, Project & Tool Creation
Languages    : Batch, Powershell, Html, Css, Js
Environments : Windows 10/11, Virtual Machines, Kali Linux, Endeavor OS, Ubuntu
```
[![Skills](https://skillicons.dev/icons?i=html,css,js,powershell,sublime,cloudflare,windows,kali,linux&theme=dark)](https://skillicons.dev)

![Counter](https://counter.lunoxia.net/get/@asveria?theme=moebooru)

<h2 align="center">current project</h2>

<img src="https://raw.githubusercontent.com/asveria/asveria/refs/heads/main/Laundered.png" width="150" align="left">

Laundered.cash is a stylish invite only bio/portfolio service, the project was founded on April 12th of 2026 by the user @rich. This service allows its users to display their online presence with confidence through sleek dashboards with a variety of features, that provide well rounded page customization and functionality.
